...
def makeHistos(channel,var, bin, xlow, finalcuts,varname):
    ...
    for Type in List:
        ...
        if (Type.startswith('GJets')):
            ...
            cut_standard= "(Pho_Pt > 45 && Pho_Pt<60.  && Pho_R9>0.9 &&TMath::Abs(Pho_Eta)<1.442 && sigmaIEtaIEta > 0.001  && sqrt(sigmaIPhiIPhi) > 0.001  && seedCrystalEnergy/(e1x3+e1x5-seedCrystalEnergy) < 0.9 &&  Pho_R9<1.0  && MET>40. && MetSig > 30 && loose_mu_10==0 && foundvetoEl_10 == 0 && MT > 100. && minMET>45.)"
