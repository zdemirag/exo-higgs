...
def plot_nice1D(channel, var, bin, low, high, ylabel, xlabel, save, setLog = False, finalcuts = False):
    ...
    for Type in List:
        ...
        trig_met   = " (  ( (0.5*0.87*(1+TMath::Erf( (MET - 55.67) / (24.76*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) < 0.5) +                            (0.5*1.0 *(1+TMath::Erf( (MET - 24.81) / (24.81*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 0.5 && TMath::Abs(dphi_pho_met) < 1.0) +                            (0.5*0.97*(1+TMath::Erf( (MET - 35.55) / (24.18*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 1.0 && TMath::Abs(dphi_pho_met) < 1.5) +                            (0.5*0.97*(1+TMath::Erf( (MET - 25.68) / (22.99*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 1.5 && TMath::Abs(dphi_pho_met) < 2.0) +                            (0.5*0.98*(1+TMath::Erf( (MET - 18.8 ) / (23.8 *sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 2.0 && TMath::Abs(dphi_pho_met) < 2.5) +                            (0.5*0.99*(1+TMath::Erf( (MET - 14.97) / (23.56*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 2.5)  )  * (MET>40.)    )"

        #trig_met   = " (  ( (0.5*0.87*(1+TMath::Erf( (MET - 55.67) / (24.76*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) < 0.5) +
        #                    (0.5*1.0 *(1+TMath::Erf( (MET - 24.81) / (24.81*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) > 0.5 && TMath::Abs(dphi_pho_met) < 1.0) +
        #                    (0.5*0.97*(1+TMath::Erf( (MET - 35.55) / (24.18*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) > 1.0 && TMath::Abs(dphi_pho_met) < 1.5) +
        #                    (0.5*0.97*(1+TMath::Erf( (MET - 25.68) / (22.99*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 1.5 && TMath::Abs(dphi_pho_met) < 2.0) +
        #                    (0.5*0.98*(1+TMath::Erf( (MET - 18.8 ) / (23.8 *sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 2.0 && TMath::Abs(dphi_pho_met) < 2.5) +
        #                    (0.5*0.99*(1+TMath::Erf( (MET - 14.97) / (23.56*sqrt(2)) ) ) ) * (TMath::Abs(dphi_pho_met) >= 2.5)  )  * (MET>40.)    )"
