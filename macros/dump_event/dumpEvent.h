...
// Mon Jan 13 14:43:41 2014 by ROOT version 5.32/00
// from TTree AnalyzerTree/H to MonoPhoton Analyzer Tree
// found on file: higgsHistograms_SinglePhotonParked_Rest.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../rootFiles/higgsHistograms_SinglePhotonParked.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../rootFiles/higgsHistograms_SinglePhotonParked.root");
      }
...
void dumpEvent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dR_JetPhoton", &dR_JetPhoton, &b_dR_JetPhoton);
