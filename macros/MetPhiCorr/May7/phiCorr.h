...
// used to generate this class and read the Tree.
   if (tree == 0) {
       //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("higgsHistograms_GJets_HT_40To100.root");
       //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("higgsHistograms_GJets_HT_100To200.root");
       //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("higgsHistograms_GJets_HT_200To400.root");
       TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("higgsHistograms_GJets_HT_400.root");

       if (!f || !f->IsOpen()) {
           //f = new TFile("higgsHistograms_GJets_HT_40To100.root");
           //f = new TFile("higgsHistograms_GJets_HT_100To200.root");
           //f = new TFile("higgsHistograms_GJets_HT_200To400.root");
           f = new TFile("higgsHistograms_GJets_HT_400.root");
      }
