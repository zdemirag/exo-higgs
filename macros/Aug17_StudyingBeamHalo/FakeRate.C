...
void FakeRate() {
  ...
  TString cut_Zeynep_n_new = "passedNum && Pho_Pt > 0. && Pho_SigmaIEtaIEta < 0.011";
  TString cut_Zeynep_d_new = "passedDen && Pho_Pt > 0. && Pho_SigmaIEtaIEta < 0.015";

  TFile *f_Iasonas = new TFile("root_file/Iasonas_Data.root","READ");
  ...
  TFile *f_Zeynep = new TFile("root_file/higgsHistograms_QCD_ratio_withMIP.root","READ");
